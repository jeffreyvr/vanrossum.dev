<nav class="py-8 px-8 md:px-0">
    <div class="max-w-xl md:max-w-5xl mx-auto relative items-center justify-center">
        ...
        <div class="md:flex content-center">
            <a href="{{ localized_route('welcome') }}" class="brand inline-block font-semibold text-white bg-gray-900 no-underline">
            ...
            <div id="nav" class="flex-1 w-full md:w-auto bg-gray-200 md:bg-transparent mt-8 md:mt-0 text-right hidden md:block">
                <a class="block md:inline-block text-left no-underline hover:underline text-gray-900 text-lg p-3" href="{{ localized_route('about') }}">{{ __('About') }}</a>
                ...
                <a class="block md:inline-block text-left no-underline hover:underline text-gray-900 text-lg p-3" href="{{ localized_route('welcome') }}#projects">{{ __('Projects') }}</a>
                <a class="block md:inline-block text-left no-underline hover:underline text-gray-900 text-lg p-3" href="{{ localized_route('contact')}}">{{ __('Contact') }}</a>
            </div>
        </div>
    </div>
</nav>
