...
<div id="app" class="h-full flex flex-col">
    ...
    <footer class="bg-gray-200 border-t" style="flex-shrink: 0;">
            ...
            <div class="sm:flex-1 text-center sm:text-left mb-6 sm:mb-0 sm:mt-3 uppercase">
                <div class="inline-block mb-4 relative w-64">
                    <select
                        ...
                        class="block appearance-none w-full bg-white border border-gray-500 hover:border-gray-800 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
