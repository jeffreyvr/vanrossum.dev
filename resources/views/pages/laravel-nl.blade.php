...
<div class="bg-white py-12 relative">
    <article class="max-w-xl md:max-w-3xl mx-auto px-8 md:px-0">
        ...
        <div class="text-xl leading-relaxed markup">
            ...
            Ik ben Jeffrey van Rossum, freelance PHP developer met ruim 5 jaar Laravel ervaring. Met Laravel heb ik door de jaren aan diverse applicaties gewerkt.
            </div>

            ## Waarom Laravel?
            [Laravel](https://laravel.com) is een zeer populair PHP framwork ontwikkeld door Taylor Otwell. Het framework stelt je in staat om snel te kunnen werken en is geschikt voor zowel simpele als complexe applicaties. Het framework is ook uitermate geschikt om API's mee te realiseren.

            Ik heb met diverse frameworks gewerkt (bijvoorbeeld Symfony en CodeIgniter), maar Laravel is verreweg het prettigst om mee te werken. Het framework maakt ook het toepassen [_Test Driven Development_](https://www.madetech.com/blog/9-benefits-of-test-driven-development) erg toegankelijk. Deze methodiek pas ik graag toe, omdat door je code grondig te testen je onnodige fouten kan voorkomen.
