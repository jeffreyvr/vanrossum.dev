...
<div class="bg-white py-12 relative">
    <article class="max-w-xl md:max-w-3xl mx-auto px-8 md:px-0">
        ...
        <div class="text-xl leading-relaxed markup">
            ...
            ## Why Laravel?
            [Laravel](https://laravel.com) is a very popular PHP framwork developed by Taylor Otwell. The framework allows you to work quickly and is suitable for both simple and complex applications. The framework is also ideal for realizing APIs.

            I have worked with various frameworks (for example Symfony and CodeIgniter), but Laravel is by far the most pleasant to work with. The framework also makes the application of [_Test Driven Development_](https://www.madetech.com/blog/9-benefits-of-test-driven-development) very accessible. I like to apply this method, because by thoroughly testing your code you can avoid unnecessary errors.
