<div class="mx-auto container">
    ...
    <div class="mt-8 text-lg max-w-2xl text-zinc-600 dark:text-zinc-400">
        <p>Ik ben Jeffrey, een freelance webdeveloper uit Nederland met een passie voor het creëren van digitale oplossingen. Ik ben gespecialiseerd in PHP-ontwikkeling en gebruik frameworks zoals <a class="underline" href="{{ localized_route('laravel') }}">Laravel</a> en <a class="underline" href="{{ localized_route('wordpress') }}">WordPress</a> om ideeën tot leven te brengen.</p>
    </div>
