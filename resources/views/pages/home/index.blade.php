<x-app-layout :title="__('Jeffrey van Rossum - Freelance PHP developer specialized in Laravel and WordPress')">
    ...
    <div class="container relative z-1 mx-auto">
        <div class="mb-8 lg:mb-16">
            @if(app()->getLocale() === 'nl')
            <h2 class="text-lg lg:text-2xl text-primary font-wide font-semibold mb-2">Waar ik aan <span class="text-secondary decoration-primary decoration-[3px] underline">gewerkt</span> heb</h2>
