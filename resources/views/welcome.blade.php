                ...
                <div class="flex-1 md:pr-12">
                    ...
                    <div class="md:flex mb-8 md:mb-0">
                        <a href="{{ localized_route('about') }}"
                           class="bg-gray-900 block md:inline-block text-lg lg:text-xl hover:bg-black text-white font-semibold py-3 px-4 shadow md:mr-4 mb-4 md:mb-0">
                            {{ __('More about me') }}
                        </a>
                        <a href="{{ localized_route('contact') }}"
                           class="bg-pink-500 block md:inline-block text-lg lg:text-xl hover:bg-pink-600 text-white font-semibold py-3 px-4 shadow">
                            {{ __('Hire me') }}
                        </a>
                    </div>
                </div>
